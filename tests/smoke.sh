...
run_check "supply-chain guard" "$ROOT_DIR/tests/unit/supply-chain.sh"
run_check "overlay conventions guard" "$ROOT_DIR/tests/unit/overlays.sh"
run_check "security token argv checks" "$ROOT_DIR/tests/unit/security-token-argv.sh"
run_check "SSH host trust guard" "$ROOT_DIR/tests/unit/security-ssh-host-trust.sh"
...
run_check "compose layering checks" "$ROOT_DIR/tests/unit/compose-layering.sh"
run_check "backend dispatch matrix" "$ROOT_DIR/tests/unit/backend-dispatch.sh"
run_check "new/rebuild lifecycle checks" "$ROOT_DIR/tests/unit/new-container-lifecycle.sh"
run_check "snapshot checks" "$ROOT_DIR/tests/unit/snapshots.sh"
run_check "snapshot-volume checks" "$ROOT_DIR/tests/unit/snapshot-volumes.sh"
run_check "internal-networking checks" "$ROOT_DIR/tests/unit/networks.sh"
