...
- **Reproducible by provenance.** Every built image records the overlay commits and content fingerprints that produced it, so you can answer "what state were my overlays in when this image was built?"
